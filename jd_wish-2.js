                    ...
                    if (safeGet(data)) {
                        ...
                        if (type) {
                            ...
                            for (let key of Object.keys(data.data.result.taskVos).reverse()) {
                                ...
                                const { taskId, taskName, waitDuration, times: timesTemp, maxTimes, status , taskType } = vo
                                if (status === 2) continue
                                let times = timesTemp
                                const other = mohuReadJson(vo, "Vos?$", -1, "taskToken")
                                if (other) {
                                ...
                                for (let activity of mohuReadJson(vo, "Vo(s)?$", maxTimes, "taskToken") || []) {
