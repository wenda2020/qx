...
async function doTask(){
    for (let i = 0; i < $.taskList.length; i++) {
        ...
        if($.oneTask.assignmentType === 3 || $.oneTask.assignmentType === 0 || $.oneTask.assignmentType === 7 || $.oneTask.assignmentType === 1){
            ...
            let subInfo = $.oneTask.ext.followShop || $.oneTask.ext.shoppingActivity || $.oneTask.ext.brandMemberList || $.oneTask.ext.productsInfo ||'';
